// Adapted from Rare UI's Notification Bell (https://github.com/swamimalode07/rare-ui),
// MIT License, Copyright (c) 2026 Swami Malode. The surface and glyph colours come from the app's theme tokens.
