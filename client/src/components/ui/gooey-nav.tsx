// Adapted from Rare UI's Gooey Nav (https://github.com/swamimalode07/rare-ui),
// MIT License, Copyright (c) 2026 Swami Malode. Next.js routing is replaced
// with react-router, and the tile colour comes from the app's theme tokens.
import {
  useEffect,
  useId,
  useState,
...
// the resting tiles sit on the page surface, so they read as a control on
// the header band rather than merging into it
const BAR = "bg-background";
const BAR_TEXT = "text-background";
...
function NavLabel({
  ...
  const props = {
    ...
    className: cn(
      "flex cursor-pointer items-center whitespace-nowrap font-medium outline-none focus-visible:ring-2 focus-visible:ring-ring [&_svg]:shrink-0",
