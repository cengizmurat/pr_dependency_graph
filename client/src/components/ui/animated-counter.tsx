// Adapted from Rare UI's Animated Counter (https://github.com/swamimalode07/rare-ui),
// MIT License, Copyright (c) 2026 Swami Malode. Unchanged apart from dropping the Next.js client directive.
