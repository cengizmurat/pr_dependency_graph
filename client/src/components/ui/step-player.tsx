// Adapted from Rare UI's Step Player (https://github.com/swamimalode07/rare-ui),
// MIT License, Copyright (c) 2026 Swami Malode. The surface, step and focus colours come from the app's theme tokens.
        ...
        >
            {showControl && (
                <motion.button
                    ...
                    className="flex shrink-0 cursor-pointer touch-manipulation select-none items-center justify-center rounded-full bg-surface outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
                >
            ...
            <div
                ...
                className="flex flex-1 items-center justify-center rounded-full bg-surface"
            >
                {items.map((step, i) => {
                    ...
                    return (
                        <motion.div
                            ...
                            className={cn(
                                ...
                                state === 'past' ? 'bg-foreground' : 'bg-muted-foreground/45',
                                seekable &&
