...
// GitHub's "share-android" octicon (16px), used by the badge that copies a
// link to a PR and the stack above it.
export const SHARE_ICON_PATH =
  "M12.5 1a2.5 2.5 0 1 1-1.938 4.076L6.454 8.13a2.51 2.51 0 0 1 0 1.74l4.108 3.054a2.5 2.5 0 1 1-.895 1.204L5.56 11.074a2.5 2.5 0 1 1 0-4.148l4.107-3.053A2.5 2.5 0 0 1 12.5 1ZM3.5 7a1 1 0 1 0 0 2 1 1 0 0 0 0-2Zm9-4.5a1 1 0 1 0 0 2 1 1 0 0 0 0-2Zm0 11a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z";
